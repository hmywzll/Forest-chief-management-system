...
public class VerifyCode {
    ...
    public BufferedImage createImage() {
        ...
        g2.setColor(this.bgColor); // 设置背景颜色为白色
        g2.fillRect(0, 0, w, h); // 在整个图像上绘制白色矩形
...
//        VerifyCode.output(verifyCode.createImage(),new FileOutputStream(new File("D:/java/xm/ForestChiefManagementSystem/src/main/resources/img/temp1.JPEG")));
//        String text1 = verifyCode.getText();
